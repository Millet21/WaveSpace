...
def find_wave_activity(waveData, freqList, dataBucketName="ComplexPhaseData", nBases=3, ):
    ...
    basesBucket = wd.DataBucket(bases,"Bases","chan_trl", chan_names)
    fitBucket = wd.DataBucket(fit,"Fit","trl_chan", chan_names)
    betasBucket = wd.DataBucket(betas,"betas","trl_chan_beta", chan_names)
